...
pca_df1 <- read.table("/shared/home/toufiktakhi/neurosporagbs/pca_splitstree_domefire/all_sites/DF1_pca.eigenvec", header=FALSE)
eval_df1 <- read.table("/shared/home/toufiktakhi/neurosporagbs/pca_splitstree_domefire/all_sites/DF1_pca.eigenval", header=FALSE)
...
# ggrepel was used here to prevent label overlapping
  ...
  labs(title = "Intraspecific PCA of Neurospora sp. populations mapped against E-DF1",
...
ggsave("/shared/home/toufiktakhi/neurosporagbs/pca_splitstree_domefire/all_sites/DF1_PCA_snps_only.pdf", width = 10, height = 7, dpi = 300)
