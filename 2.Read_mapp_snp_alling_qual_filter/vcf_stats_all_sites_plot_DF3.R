...
stats_dir    <- "/shared/home/toufiktakhi/neurosporagbs/test_12_06_26/dp_mq_all_sites/domefire/readmapping_stats_DF3/"
output_pdf   <- "/shared/home/toufiktakhi/neurosporagbs/test_12_06_26/dp_mq_all_sites/domefire/E-DF3_all_sites_stats_figures.pdf"
output_table <- "/shared/home/toufiktakhi/neurosporagbs/test_12_06_26/dp_mq_all_sites/domefire/E-DF3_all_sites_stats_summary.csv"
vcf_file     <- "/shared/home/toufiktakhi/neurosporagbs/test_12_06_26/E-DF3_all_sites_filtered.vcf.gz"
...
print(
    ...
    labs(title = "Sequencing depth (DP) per individual (subsample of 100k sites) - E-DF3",
         x = "Individual", y = "DP")
)
...
print(
    ...
    theme_minimal() +
    theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 6)) +
    labs(title = "Sequencing depth (DP) per individual (zoom 0-375, 100k subsample) - E-DF3",
         x = "Individual", y = "DP")
)
...
print(
    ...
    labs(title = "Mapping quality (MQ) distribution - E-DF3", x = "MQ", y = "Count")
)
...
print(
    ...
    labs(title = "Variant quality (QUAL) distribution - E-DF3", x = "QUAL", y = "Count")
)
