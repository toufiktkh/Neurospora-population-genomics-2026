...
# Vill data
df <- read.csv("mapping_stats_vill.csv", stringsAsFactors = FALSE)
...
ggsave("heatmap_stats_vill.pdf", plot = plot_vill, width = 8, height = 12, limitsize = FALSE)

cat("Success: 'heatmap_stats_vill.pdf' has been generated.\n")
