...
stats_dir    <- "/shared/home/toufiktakhi/neurosporagbs/test_12_06_26/dp_mq_all_sites/vill/"
output_pdf   <- "/shared/home/toufiktakhi/neurosporagbs/test_12_06_26/dp_mq_all_sites/vill/Vill_stats_all_sites_figures.pdf"
output_table <- "/shared/home/toufiktakhi/neurosporagbs/test_12_06_26/dp_mq_all_sites/vill/Vill_stats_all_stats_summary.csv"
vcf_file     <- "/shared/home/toufiktakhi/neurosporagbs/test_12_06_26/Vill-A1-3_all_sites_filtered.vcf.gz"

dp_file   <- file.path(stats_dir, "all_samples_DP_matrix.txt.gz")
mq_file   <- file.path(stats_dir, "all_sites_MQ.txt.gz")
qual_file <- file.path(stats_dir, "Vill-A1-3_QUAL.txt.gz")
...
print(
    ...
    labs(title = "Sequencing depth (DP) per individual (subsample of 100k sites) - Vill-A1-3",
         x = "Individual", y = "DP")
)
...
print(
    ...
    theme_minimal() +
    theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 6)) +
    labs(title = "Sequencing depth (DP) per individual (zoom 0-375, 100k subsample) - Vill-A1-3",
         x = "Individual", y = "DP")
)
...
print(
    ...
    labs(title = "Mapping quality (MQ) distribution - Vill-A1-3", x = "MQ", y = "Count")
)
...
print(
    ...
    labs(title = "Variant quality (QUAL) distribution - Vill-A1-3", x = "QUAL", y = "Count")
)
